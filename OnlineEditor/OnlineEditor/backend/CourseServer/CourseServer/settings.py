"""
Django settings for CourseServer project.
...
ROOT_URLCONF = "CourseServer.urls"
...
WSGI_APPLICATION = "CourseServer.wsgi.application"
...
# Channels
ASGI_APPLICATION = "CourseServer.asgi.application"
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # 静态文件的根目录
]
...
# Static files (CSS, JavaScript, Images)
# https://docs.djangoproject.com/en/2.2/howto/sttic-files/
